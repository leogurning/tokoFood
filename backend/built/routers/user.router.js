...
router.post("/login", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, _b, _c, _, userActive;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 3:
                ...
                if (_b) {
                    _c = user.toObject(), _ = _c.password, userActive = __rest(_c, ["password"]);
...
router.post('/register', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, address, user, encryptedPassword, newUser, dbUser, _b, _, userActive;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                dbUser = _c.sent();
                _b = dbUser.toObject(), _ = _b.password, userActive = __rest(_b, ["password"]);
                res.send(generateTokenReponse(userActive));
                return [2 /*return*/];
        }
    });
